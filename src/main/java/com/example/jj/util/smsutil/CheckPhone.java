package com.example.jj.util.smsutil;
...
public class CheckPhone
{
	...
	public static void verifyphone(String phone,String content)
	{
		// 用户账号
		String userid = "E108YL";
		// 用户密码
		String pwd = "sSrJiW";
		...
		// 单条发送
		singleSend(userid, pwd,isEncryptPwd,phone,content);
	 ...
	 */
	public static void singleSend(String userid, String pwd,boolean isEncryptPwd,String phone,String content)
	{
		try
		{
			// 参数类
